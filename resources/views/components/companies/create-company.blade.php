<div id="createPage" tabindex="-1" aria-hidden="true"
    ...
    <div id="createContainer" class=" relative p-4 w-full max-w-2xl h-full md:h-auto">
        <!-- Modal content -->
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <!-- Modal body -->
            <form id="createForm" action="{{route('createCompany')}}" method="POST">
