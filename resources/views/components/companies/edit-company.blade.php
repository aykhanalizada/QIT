<div id="editPage" tabindex="-1" aria-hidden="true"
    ...
    <div id="editContainer" class=" relative p-4 w-full max-w-2xl h-full md:h-auto">
        <!-- Modal content -->
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <!-- Modal body -->
            <form id="editForm" action="{{route('updateCompany')}}" method="POST">
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div>
                        <label for="VOEN"
                               class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">VOEN
                        </label>
                        <input type="text" name="VOEN"
                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                               placeholder="121212">
                    </div>
                ...
                <div id="errorEdit" class="flex p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 hidden" role="alert">
                    ...
                    <div>
                        ...
                        <ul id="errorMessageEdit" class="mt-1.5 list-disc list-inside">
