<div id="editUserPage" tabindex="-1" aria-hidden="true"
    ...
    <div id="editUserContainer" class=" relative p-4 w-full max-w-2xl h-full md:h-auto">
        <!-- Modal content -->
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                ...
                <button type="button"
                        ...
                        data-modal-target="editUserPage">
            ...
            <!-- Modal body -->
            <form id="updateUserForm" action="{{route('updateUser') }}" method="POST">
                @csrf
                ...
                <div>
                    ...
                    <div class=" border-t sm:mb-5 dark:border-gray-600 pt-4  ">
                        ...
                        <i id="toggleEye" class="far fa-eye text-gray-600" onclick="togglePasswordVisibility()"></i>
